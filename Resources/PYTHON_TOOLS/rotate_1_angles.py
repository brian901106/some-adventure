"""
 ...
 Ver. 2: 2019/9/8
 作者: 王一哲
 https://hackmd.io/@yizhewang/H1ArzImf7?type=view
"""
from vpython import *
import time
...
size = 0.2          # 小球半徑
L = 5               # 擺長
theta0 = radians(70)# 起始擺角, 用 radians 將單位換成 rad
theta = theta0      # 擺角
g = 9.8             # 重力加速度
...
# 固定時長測角度
    now_time = time.time()
    last_time = sampling(now_time,last_time)
# 檢驗小球是否經過一個週期
    omega_c = omega
