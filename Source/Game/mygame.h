...
namespace game_framework {
	...
	private:
		...
		int mine_random_num = 1;			//關卡隨機呈現  mine_random_num = 1 時跑第一組關卡,= 2 時跑第二組關卡,= 3 三
		...
		int mine_num_1[10][13] = {  { 4,3,0,2,3,0,2,0,3,0,2,0,2 },		//第1關 mine_random_num = 1
									{ 7,2,0,2,0,0,4,0,0,1,1,0,3 },		//第2關
									{ 4,3,0,1,0,0,4,0,0,1,1,0,3 },		//第3關
									{ 4,1,2,0,1,0,3,0,0,1,4,0,1 },		//第4關
		...
		int mine_num_2[10][13] = {  { 5,3,0,2,0,0,2,0,0,0,1,0,2 },		//第1關 mine_random_num = 2
									{ 7,3,0,2,0,0,4,0,0,0,1,0,3 },		//第2關
									{ 4,3,0,1,0,0,4,0,0,1,1,0,3 },		//第3關
									{ 4,3,2,0,3,0,3,0,0,0,2,0,1 },		//第4關
									{ 4,3,1,2,2,0,3,0,0,3,1,0,1 },		//第5關
									{ 7,3,0,1,0,0,3,0,4,2,1,0,3 },		//第6關
									{ 2,0,2,3,6,2,0,2,0,0,1,2,0 },		//第7關
									{ 0,0,0,0,0,0,0,5,3,8,2,0,0 },		//第8關
									{ 1,0,0,2,0,1,0,7,4,7,3,1,0 },		//第9關
									{ 1,0,0,2,0,1,5,7,4,7,3,1,0 } };	//第10關

		int mine_num_3[10][13] = {  { 5,3,0,2,0,0,2,0,0,0,1,0,2 },		//第1關 mine_random_num = 3
									{ 7,2,0,2,0,0,4,0,0,1,1,0,3 },		//第2關
									{ 4,3,0,1,0,0,4,0,0,1,1,0,3 },		//第3關
									{ 4,3,2,0,3,0,3,0,0,0,2,0,1 },		//第4關
									{ 4,3,2,2,2,0,3,0,0,3,1,0,1 },		//第5關
									{ 7,3,0,1,0,0,3,0,4,2,1,0,3 },		//第6關
									{ 2,0,2,3,6,2,0,2,0,0,1,2,0 },		//第7關
									{ 0,0,0,5,0,0,9,2,0,4,0,0,7 },		//第8關
									{ 1,0,0,0,4,0,0,1,5,0,1,0,0 },		//第9關
									{ 1,0,0,2,0,1,5,7,4,7,3,1,0 } };	//第10關
		...
		int last_time_pig6[10];			//分開控制每隻豬的上次移動時間
		int last_time_pig10[10];		//分開控制每隻鑽石豬的上次移動時間
